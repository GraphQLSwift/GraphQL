...
public let GraphQLInt = try! GraphQLScalarType(
    ...
    serialize: { try .int($0.map.asInt(converting: true)) } ,
    parseValue: { try .int($0.map.asInt(converting: true)) },
    parseLiteral: { ast in
...
public let GraphQLFloat = try! GraphQLScalarType(
    ...
    serialize: { try .double($0.map.asDouble(converting: true)) } ,
    parseValue: { try .double($0.map.asDouble(converting: true)) },
    parseLiteral: { ast in
...
public let GraphQLString = try! GraphQLScalarType(
    ...
    serialize: { try .string($0.map.asString(converting: true)) } ,
    parseValue: { try .string($0.map.asString(converting: true)) },
    parseLiteral: { ast in
...
public let GraphQLBoolean = try! GraphQLScalarType(
    ...
    serialize: { try .bool($0.map.asBool(converting: true)) } ,
    parseValue: { try .bool($0.map.asBool(converting: true)) },
    parseLiteral: { ast in
