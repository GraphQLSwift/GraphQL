...
//    }
    ...
    func testCorrectlyAssignASTNodes() throws {
        ...
        let testUnion = try XCTUnwrap(schema.getType(name: "TestUnion") as? GraphQLUnionType)
        ...
        let testScalar = try XCTUnwrap(schema.getType(name: "TestScalar") as? GraphQLScalarType)
        let testDirective = try XCTUnwrap(schema.getDirective(name: "test"))

        // TODO: No `Equatable` conformance
//        XCTAssertEqual(
//            [
//              schema.astNode,
//              query.astNode,
...
//        )
        ...
        // TODO: Lots of types missing `astNode`
...
//        )
//        try XCTAssertEqual(
//            print(ast: XCTUnwrap(testInput.fields["testInputField"]?.astNode)),
//            "testInputField: TestEnum"
//        )
//
//        try XCTAssertEqual(
