...
@Suite struct StarWarsValidationTests {
    @Test func nestedQueryWithFragment() throws {
        let query =
            "query NestedQueryWithFragment {" + "    hero {" + "        ...NameAndAppearances"
            + "        friends {" + "            ...NameAndAppearances" + "             friends {"
            + "                 ...NameAndAppearances" + "             }" + "        }" + "    }"
            + "}"
    ...
    @Test func heroNoFieldsQuery() throws {
        let query = "query HeroNoFieldsQuery {" + "    hero" + "}"
    ...
    @Test func heroFieldsOnScalarQuery() throws {
        let query =
            "query HeroFieldsOnScalarQuery {" + "    hero {" + "        name {"
    ...
    @Test func droidFieldOnCharacter() throws {
        let query =
            "query DroidFieldOnCharacter {" + "    hero {" + "        name"
            + "        primaryFunction"
            + "    }" + "}"
    ...
    @Test func droidFieldInFragment() throws {
        let query =
            "query DroidFieldInFragment {" + "    hero {" + "        name"
            + "        ...DroidFields"
    ...
    @Test func droidFieldInInlineFragment() throws {
        let query =
            "query DroidFieldInInlineFragment {" + "    hero {" + "        name"
